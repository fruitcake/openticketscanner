...
function pickMessage(body, status, messages) {
 ...
 */
export function parseTicketResponse(body, httpStatus, messages = DEFAULT_MESSAGES) {
...
export function errorResult(message, raw) {
